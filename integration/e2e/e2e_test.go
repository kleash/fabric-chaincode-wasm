...
var _ = Describe("E2e", func() {
	...
	It("is able to deploy and execute wasmcc contract", func() {
		...
		RunQuerInstalledChaincodesEmpty(network, orderer, peer, "testchannel")
		...
		RunQuerInstalledChaincodesExists(network, orderer, peer, "testchannel")
...
func RunQuerInstalledChaincodesExists(n *nwo.Network, orderer *nwo.Orderer, peer *nwo.Peer, channel string) {
...
func RunQuerInstalledChaincodesEmpty(n *nwo.Network, orderer *nwo.Orderer, peer *nwo.Peer, channel string) {
	sess, err := n.PeerUserSession(peer, "User1", commands.ChaincodeQuery{
		ChannelID: channel,
		Name:      "wasmcc",
		Ctor:      `{"Args":["installedChaincodes",""]}`,
