...
build: bin/c_chaincode_example02
...
bin/c_chaincode_example02:
	mkdir -p bin/c_chaincode_example02
	cd sample-wasm-chaincode/chaincode_example02/c && clang-8 --target=wasm32 -O3 -flto -nostdlib -Wl,--no-entry -Wl,--export-all -Wl,--lto-O3 -o ../../../bin/c_chaincode_example02/app_main.wasm main.c
